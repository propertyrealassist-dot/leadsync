...
async function initializeDatabase(retries = 3) {
  ...
  try {
    ...
    try {
      ...
      await client.query(`ALTER TABLE leads ADD COLUMN IF NOT EXISTS assigned_to UUID`);
      ...
      await client.query(`ALTER TABLE leads ADD COLUMN IF NOT EXISTS template_id UUID`);
      await client.query(`ALTER TABLE leads ADD COLUMN IF NOT EXISTS organization_id UUID`);
